...
# Al iniciar sesión, vuelve a la página principal
LOGIN_REDIRECT_URL = 'index'

# Al cerrar sesión, vuelve a la página principal
LOGOUT_REDIRECT_URL = 'index'

# Configuracion de correo (usar variables de entorno fuera de desarrollo)
